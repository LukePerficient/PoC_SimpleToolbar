...
+ (void)alertUserWithCreateMessage:(UIView *)view
{
    ...
    [view makeToast:@"Creating object to add to Persistence Layer" duration:1.0 position:toastCenterPoint];
}
...
+ (void)alertUserWithDeleteMessage:(UIView *)view
{
    ...
    [view makeToast:@"Deleteing object from Persistence Layer" duration:1.0 position:toastCenterPoint];
}
...
+ (void)alertUserWithUpdateMessage:(UIView *)view
{
    ...
    [view makeToast:@"Updating object to Persistence Layer" duration:1.0 position:toastCenterPoint];
}
...
+ (void)alertUserWithReadMessage:(UIView *)view
{
    ...
    [view makeToast:@"Reading object from Persistence Layer" duration:1.0 position:toastCenterPoint];
}
